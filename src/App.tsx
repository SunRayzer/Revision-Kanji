...
const DATA = [
  ...
  { id: "北", meaningFR: "nord", meaningEN: "north", onyomi: ["ホク"], kunyomi: ["きた"], aSavoir: ["きた"] },
  { id: "南", meaningFR: "sud", meaningEN: "south", onyomi: ["ナン"], kunyomi: ["みなみ"], aSavoir: ["みなみ"] },
  { id: "西", meaningFR: "ouest", meaningEN: "west", onyomi: ["セイ","サイ"], kunyomi: ["にし"], aSavoir: ["にし"] },
  { id: "東", meaningFR: "est", meaningEN: "east", onyomi: ["トウ"], kunyomi: ["ひがし"], aSavoir: ["ひがし"] },
  { id: "目", meaningFR: "œil; oeil", meaningEN: "eye", onyomi: ["モク","ボク"], kunyomi: ["め"], aSavoir: ["め"] },
  { id: "耳", meaningFR: "oreille", meaningEN: "ear", onyomi: ["ジ"], kunyomi: ["みみ"], aSavoir: ["みみ"] },
  { id: "口", meaningFR: "bouche", meaningEN: "mouth", onyomi: ["コウ","ク"], kunyomi: ["くち"], aSavoir: ["くち"] },
